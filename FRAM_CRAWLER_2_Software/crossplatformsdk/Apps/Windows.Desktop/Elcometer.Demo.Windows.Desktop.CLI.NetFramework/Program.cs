...
namespace Elcometer.Demo.Windows.Desktop.CLI
{
    internal class Program
    {
        private static void Main(string[] args)
        {
            ...
            Console.WriteLine("Enumerating Elcometer USB devices");

            var devices = ElcometerCore.Instance.ConnectionService.GetUSBDevices();
